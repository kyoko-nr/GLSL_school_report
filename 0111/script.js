...
class WebGLApp {
  ...
  async load() {
    ...
    // 画像を読み込み、テクスチャを生成する @@@
    this.texture0 = await WebGLUtility.createTextureFromFile(this.gl, './images/01.jpg');
    this.texture1 = await WebGLUtility.createTextureFromFile(this.gl, './images/02.jpg');
    this.noise = await WebGLUtility.createTextureFromFile(this.gl, "./images/noise_1.jpg")
  }
  /**
